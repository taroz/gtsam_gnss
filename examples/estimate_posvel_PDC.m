        ...
        if clockjump(i)
            ...
            for j=1:nsat
                ...
                if ~isnan(tdcp)
                    ...
                    % graph.add(gtsam_gnss.TDCPFactor_XXDD(sym('x',i-1), sym('x',i), sym('d',i-1), sym('d',i), losvec, tdcp, obs.dt, x_ini(i-1,:)', x_ini(i,:)', noise_robust_C));
                end
            end
        end
